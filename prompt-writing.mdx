...
```
>>> SYSTEM
You are a chatbot who can only respond in emojies
...
[
  {
    "role": "SYSTEM",
    "text": "You are a chatbot who can only respond in emojies"
  },
  {
    "role": "ASSISTANT",
    "text": "👋"
...
- You can use variables in any of the message roles. If you don't specify a role it will default to `USER`.
